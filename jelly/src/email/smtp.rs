...
fn env_exists_and_not_empty(env: &str) {
...
impl Email {
    ...
    pub fn send(self) -> Result<(), anyhow::Error> {
        ...
        let reply_to = var("JELLY_SUPPORT_EMAIL").or_else::<anyhow::Error,_>(|_v| Ok(self.from.clone())).unwrap();
        ...
        let email = Message::builder()
            ...
            .multipart(MultiPart::alternative_plain_html(self.body, self.bodyhtml))?;
